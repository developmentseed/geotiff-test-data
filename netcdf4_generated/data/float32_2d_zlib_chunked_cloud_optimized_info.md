```
HDF5 "/Users/max/Documents/Code/claude-workspaces/virtualizarr/netcdf-test-data/netcdf4_generated/data/float32_2d_zlib_chunked_cloud_optimized.nc" {
GROUP "/" {
   ...
   DATASET "temperature" {
      ...
      STORAGE_LAYOUT {
         CHUNKED ( 1, 128, 256 )
         SIZE 169048937 (1.241:1 COMPRESSION)
      }
      FILTERS {
