"""Generate an 3 Bands GeoTIFF with DEFLATE compression and undefined color interpretation."""
...
def generate(output_path: Path) -> None:
    ...
    write_cog(
        ...
        blocksize=64,
        compress="DEFLATE",
        colorinterp=[ColorInterp.grey, ColorInterp.undefined, ColorInterp.undefined],
    )
